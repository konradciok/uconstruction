...
export class Portfolio2Manager {
  static async getAllArtworks(): Promise<Artwork[]> {
    portfolioLogger.warn('Portfolio2Manager.getAllArtworks() is deprecated. Use artwork-fetcher instead.');
    return [];
  }

  static async getPortfolioStats(): Promise<PortfolioStats> {
    portfolioLogger.warn('Portfolio2Manager.getPortfolioStats() is deprecated.');
    return {
      total: 0,
      uploaded: 0,
  ...
  static getSourceConfig(): SourceConfig {
    portfolioLogger.warn('Portfolio2Manager.getSourceConfig() is deprecated.');
    return {
  ...
  static async addArtworks(_artworks: Artwork[]): Promise<void> {
    portfolioLogger.warn('Portfolio2Manager.addArtworks() is deprecated. Use upload-service instead.');
  }

  static async updateArtwork(_id: string, _artwork: Artwork): Promise<void> {
    portfolioLogger.warn('Portfolio2Manager.updateArtwork() is deprecated.');
  }

  static async removeArtwork(_id: string): Promise<void> {
    portfolioLogger.warn('Portfolio2Manager.removeArtwork() is deprecated.');
  }

  static async listUploadedArtworks(): Promise<Artwork[]> {
    portfolioLogger.warn('Portfolio2Manager.listUploadedArtworks() is deprecated.');
    return [];
  }

  static async refreshArtworks(): Promise<void> {
    portfolioLogger.warn('Portfolio2Manager.refreshArtworks() is deprecated.');
  }

  static exportPortfolioData(): void {
    portfolioLogger.warn('Portfolio2Manager.exportPortfolioData() is deprecated.');
  }
}
